...
def test_s2_sst_file_truncated_and_repair():
    """
    S2：SST 文件大小变小。

    用例自己构造 SST：
      write -> flushmem -> wait new SST -> truncate SST
    """
    ctx = RepairAT()
    ...
    # ---------- T5：关闭 heartbeat，停止目标 shardsvr，截断 SST ----------
