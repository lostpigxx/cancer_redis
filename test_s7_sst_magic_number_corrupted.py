# test_s7_sst_magic_number_corrupted.py
...
def test_s7_sst_magic_number_corrupted_and_repair():
    """
    S7：SST magic number 损坏。

    用例自己构造 SST：
      write -> flushmem -> wait new SST -> corrupt SST magic number
    """
    ctx = RepairAT()
    ...
    # ---------- T5：关闭 heartbeat，停止目标 shardsvr，损坏 SST magic number ----------
